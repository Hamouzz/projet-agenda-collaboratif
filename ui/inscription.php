...
<section>
	<h1>S'INSCRIRE</h1>
<form method="post" action="membres/action.php" enctype="multipart/form-data">
	<table>
		<tr>
		...
		<tr>
			<td>Email:</td>
			<td><input type="mail" name="mail" <?php  if (!empty($_SESSION['emailins'])){echo "value='".$_SESSION['emailins']."'";} ?>></td>
		</tr>
		<tr>
			<td>Mot de passe:</td>
